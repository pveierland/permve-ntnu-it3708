...
../program/flatland.py --agent supervised --sensor_range 1 ${parameters} --baseline_take_food_near_wall --baseline_prefer_right > learning-curve-supervised-1-sensor-range-${training_rounds}-training-rounds-${training_round_size}-size-${training_round_repetitions}-repetitions.txt
